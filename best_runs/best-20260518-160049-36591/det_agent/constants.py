...
# Approx kitchen throughput (covers per staff per day) — recalibrated from peak
# observed daily covers (477 on Sat with 14 staff = ~34 covers/staff).
KITCHEN_THROUGHPUT_PER_STAFF = 30.0
TABLE_CAPACITY_NORMAL = 500   # peak observed 477 covers/day — table+turn cap
